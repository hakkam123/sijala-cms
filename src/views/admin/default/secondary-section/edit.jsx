...
const SecondarySectionEdit = () => {
  ...
  useEffect(() => {
    const existingData = {
      ...
      description: "Mengembangkan program konservasi yang berkelanjutan",
  ...
  const handleSubmit = (e) => {
    ...
    alert("Secondary Section berhasil diupdate!");
...
export default SecondarySectionEdit;
