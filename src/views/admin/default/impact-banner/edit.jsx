...
const ImpactBannerEdit = () => {
  ...
  useEffect(() => {
    const existingData = {
      id: id,
      image: "/path/to/impact1.jpg",
      title: "Bergabunglah dalam Misi Konservasi",
      subtitle: "Bersama Kita Kuat",
      description: "Mari bersama-sama menjaga kelestarian laut Indonesia",
  ...
  const handleSubmit = (e) => {
    ...
    alert("Impact Banner berhasil diupdate!");
    navigate("/admin/default/impact-banner");
  };
  ...
  return (
    <div className="mt-5 animate-fade-in">
      <Card extra="p-5">
        <button
          onClick={() => navigate("/admin/default/impact-banner")}
...
export default ImpactBannerEdit;
