        ...
        <div className="mb-5">
          ...
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold text-navy-700 dark:text-white">
              Manajemen Indikator EVIKA
            </h2>
            <button
              onClick={() => navigate("/admin/evika/indikator/create")}
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200 dark:border-navy-600">
                ...
                <th className="text-left py-3 px-4 text-navy-700 dark:text-white">Nama Indikator</th>
                ...
                <tr key={item.id} className="border-b border-gray-200 dark:border-navy-600">
                  ...
                  <td className="py-3 px-4">
                    <div className="flex justify-center gap-2">
                      <button
                        onClick={() => navigate(`/admin/evika/indikator/edit/${item.id}`)}
...
export default IndikatorManagement;
